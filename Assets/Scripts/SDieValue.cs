...
public class SDieValue : MonoBehaviour
{
		...
		void  FixedUpdate ()
		{
				...
				if (!GameManager.instance.rollDiceForAttack) {
						...
						if (GameManager.instance.rollForExplosion) {
								...
								if (GameManager.instance.rollForAmbush) {

										if (GetComponent<Rigidbody> ().IsSleeping ()) {

												GameManager.instance.AmbushFinalResult (currentValue);
										}
								...
								} else if (GameManager.instance.rollForTreatmentFromAfar) {
										...
										if (GetComponent<Rigidbody> ().IsSleeping ()) {
												...
												GameManager.instance.DoTreatmentFromAfar (total);  
